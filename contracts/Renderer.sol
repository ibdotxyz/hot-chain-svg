...
contract Renderer {
    function render(uint256 _tokenId) public view returns (string memory) {
        uint256 tokenBalance = 210;
        uint256 lockedBalance = 21000000000;
        // Assuming font size is 24px, the width of monospace is roughly 14px wide.
        uint256 balanceWidth = 14 * (bytes(thousandSeparator(tokenBalance)).length + 11);
        uint256 lockedWidth = 14 * (bytes(thousandSeparator(lockedBalance)).length + 10);
        uint256 unlockTime = blockTimestamp() + 365 days + 363 days + 0 hours;
        return
            string.concat(
...
//                '<line x1="29" y1="29" x2="900" y2="29" stroke="red" />',
//                '<line x1="29" y1="29" x2="29" y2="1200" stroke="red" />',
//                '<line x1="682" y1="29" x2="682" y2="1200" stroke="red" />',
//                '<line x1="55" y1="29" x2="55" y2="1200" stroke="red" />',
//                '<line x1="658" y1="29" x2="658" y2="1200" stroke="red" />',
//                '<line x1="29" y1="937" x2="900" y2="937" stroke="red" />',
//                '<line x1="68" y1="29" x2="68" y2="1200" stroke="red" />',
//                '<line x1="29" y1="1033" x2="900" y2="1033" stroke="red" />',
                svg.text(
                    string.concat(
                        svg.prop('x', '64px'),
                        svg.prop('y', '640px'),
                ...
                svg.text(
                    ...
                    formatUnlockDuration(unlockTime)
                ),
    ...
    function tokenBalance() internal pure returns (uint256) {
        return 0;
    }

    function lockedBalance() internal pure returns (uint256) {
        return 0;
    }
